...
- [Installing Tanzu Application Platform](install-intro.md)
  ...
  - [Cluster Essentials for Tanzu](cluster-essentials.md)
    ...
    - [Supply Chain Security Tools for Tanzu – Store](scst-store/overview.md)
      ...
      - [CLI overview](scst-store/cli-overview.md)
          ...
          - [CLI commands](scst-store/cli-docs/insight.md)
              ...
              - [Insight image](scst-store/cli-docs/insight-image.md)
              - [Insight package](scst-store/cli-docs/insight-package.md)
              - [Insight source](scst-store/cli-docs/insight-source.md)
              - [Insight version](scst-store/cli-docs/insight-version.md)
              - [Insight vulnerabilities](scst-store/cli-docs/insight-vulnerabilities.md)
